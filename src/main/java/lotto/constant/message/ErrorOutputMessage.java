...
public final class ErrorOutputMessage {
    ...
    public static final String PURCHASE_REMAINDER
            = ERROR + "구매 금액은 " + LottoNumber.PURCHASE_AMOUNT_COND.getValue() + "으로 나누어 떨어져야 합니다.";

    public static final String NUMBER_COUNT
            = ERROR + "당첨 번호는 " + LottoNumber.MAX_COUNT.getValue() + "개를 입력해야 합니다.";
    ...
    public static final String NUMBER_RANGE
            = ERROR + "로또 번호는 " + LottoNumber.FIRST_RANGE.getValue() + "부터 " + LottoNumber.LAST_RANGE.getValue() + " 사이의 숫자여야 합니다.";
}
